...
| 2026-09-11 (4) | Rebuilt the overview as a camera lift over the real world (D31, D31b) after the abstract-map version was rejected. Excluded My Work from it. **Open question:** whether the overview should merge into the closing slide (overview + the project cards together) rather than being its own mode. | **Phase 4**; **O2** Vite; **O4** |
