export const projects = [
  {
    title: "CodepenAI",
    description:
      "A codepen style code editor powered by AI using external APIs. Build and modify web apps via prompts or write and modify the code yourself.Back-end consists of an API with a connection to a MySQL server using Entity Framework. No back-end in the live demo yet, the data resets on page reload.",
    details: [
      "OpenAI API used for code generation, API key required",
      "Unsplash API used for getting images"
    ],
    technologies: ["react", "node", "csharp", "entityfw", "sql"],
