export const featuredProjects = [
  {
    ...
    media: "video",
    description:
      "A codepen style code editor powered by AI using external APIs. Build and modify web apps via prompts or write and modify the code yourself. Back-end consists of a REST API with a connection to a MySQL server using Entity Framework. No back-end in the live demo yet, the data resets on page reload.",
    details: [
      "OpenAI API used for code generation, API key required",
      "Unsplash API used for getting images"
    ],
    technologies: ["ai", "react", "csharp", "sql", "aws", "html", "css", "js"],
...
export const allProjects = [
  {
    ...
    technologies: ["ai", "react", "node", "html", "css", "js"],
  ...
  },
  {
    ...
    technologies: ["react", "csharp", "sql", "html", "css", "js"],
  ...
  },
  {
    ...
    technologies: ["csharp"],
    repository: "https://github.com/Connectslide121/Vending-Machine",
    date: "November 2023"
  },
  {
  ...
  },
  {
    ...
    technologies: ["csharp"],
    repository: "https://github.com/Lexicon-Group-4/Lawn-Mower-Rental-App",
    date: "October 2023"
  },
  {
    title: "Flapry Blirb",
